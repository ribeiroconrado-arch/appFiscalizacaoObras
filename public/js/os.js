...
// ── A LISTA E AS ABAS SAÍRAM DAQUI ───────────────────────────
//
// A tela tinha duas abas — Protocolos e Ordens de serviço — que respondiam à
// mesma pergunta e obrigavam a olhar duas listas para saber o que estava
// pendente. Viraram UMA fila, em demandas.js.
//
// O que ficou é o que NÃO se unificou: a ficha, o formulário, as jornadas, a
// ciência do fiscal e a assinatura de quem emite — nada disso existe no
// protocolo.
//
// `carregarOs` continua existindo porque vários pontos a chamam para atualizar
// a tela depois de gravar; hoje ela recarrega a fila inteira.
function carregarOs() { return carregarDemandas() }
